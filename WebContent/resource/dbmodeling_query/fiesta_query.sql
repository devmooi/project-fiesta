...
CREATE TABLE company(
	com_email VARCHAR(45) NOT NULL PRIMARY KEY,
...
ALTER TABLE service ADD constraint fk_service foreign key(com_email) references company(com_email) on delete cascade;
...
ALTER TABLE custorder ADD constraint fk_custorder_company foreign key(com_email) references company(com_email) on delete cascade;
...
ALTER TABLE orderdetail ADD constraint fk_orderdetail_company foreign key(com_email) references company(com_email) on delete cascade;
...
ALTER TABLE review ADD constraint fk_review_company foreign key(com_email) references company(com_email) on delete cascade;
...
ALTER TABLE wish ADD constraint fk_wish_company foreign key(com_email) references company(com_email) on delete cascade;
...
ALTER TABLE answer ADD constraint fk_answer_company foreign key(com_email) references company(com_email) on delete cascade;
...
INSERT INTO service(service_name, service_desc, service_img, service_tag, com_email)
VALUES('300명 숙소', '다양한 강당, 편안한 시설', './resource/img/house1.jpg', '#숙소', 'ent1@gmail.com');
INSERT INTO service(service_name, service_desc, service_img, service_tag, com_email)
VALUES('MC', '경험 많은 MC', './resource/img/house1.jpg', '#섭외#MC', 'ent2@gmail.com');
INSERT INTO service(service_name, service_desc, service_img, service_tag, com_email)
VALUES('연예인', '경험 많은 연예인', './resource/img/house1.jpg', '#섭외#연예인', 'bohum1@gmail.com');
INSERT INTO service(service_name, service_desc, service_img, service_tag, com_email)
VALUES('45인승버스', '안락한 45인승 리무진 버스', './resource/img/house1.jpg', '#버스#45인승', 'rent1@gmail.com');
