...
VALUES('아트뱅크(ArtBank)', '031-719-8511', '경기도 성남시 분당구 정자로 76번길 13, 현빌딩 2층 전층', 'resource/img/sound1.jpg', '유/무선 마이크, 핀 마이크, 헤드폰, 스피커 등 렌탈 및 판매, 음향 영상 시공', 5);
...
INSERT INTO company(com_name, com_tel, com_addr, com_img, com_desc, comCategory_code)
VALUES('SLR렌트(SLRRENT)', '02-587-2470', '서울시 강남구 테헤란로6길 9 (역삼동, 장원빌딩 1층)', 'resource/img/camera1.jpg', '국내 최대 사진 영상 촬영장비 대여', 5);
INSERT INTO company(com_name, com_tel, com_addr, com_img, com_desc, comCategory_code)
VALUES('이브코드', '031-714-3011', '경기도 성남시 분당구 성남대로343번길 10-6 (정자동) 3층 344호', 'resource/img/brand1.jpg', '건국대학교 D.O.N 행사 협찬 경력', 10);

INSERT INTO company(com_name, com_tel, com_addr, com_img, com_desc, comCategory_code)
VALUES('스마트음향', '02-3272-7880', '서울시 용산구 한강로 3가 9-23 나진상가15동 132호', 'resource/img/sound2.jpg', '무선마이크, 스피커 렌탈', 5);
INSERT INTO company(com_name, com_tel, com_addr, com_img, com_desc, comCategory_code)
...
INSERT INTO company(com_name, com_tel, com_addr, com_img, com_desc, comCategory_code)
VALUES('썸렌탈(SOME Film & Digital)', '02-2256-6828', '서울시 중구 신당2동 353-8 호연재빌딩 1층', 'resource/img/film1.jpg', '디지털카메라(소니, ARRI, RED), 필름카메라 다수 보유', 5);
INSERT INTO company(com_name, com_tel, com_addr, com_img, com_desc, comCategory_code)
VALUES('무백', '02-511-3060', '서울특별시 성동구 뚝섬로1길 25(성수동1가) 서울숲한라에코밸리 901호', 'resource/img/brand2.jpg', '이화여대 영상제 제품 협찬 경력', 10);

INSERT INTO company(com_name, com_tel, com_addr, com_img, com_desc, comCategory_code)
VALUES('사운드몰', '02-719-2077', '서울시 용산구 효창동 5-477번지 102호', 'resource/img/sound3.jpg', '무선마이크, 행사음향기기 대여 전문', 5);
INSERT INTO company(com_name, com_tel, com_addr, com_img, com_desc, comCategory_code)
...
INSERT INTO company(com_name, com_tel, com_addr, com_img, com_desc, comCategory_code)
VALUES('미디어렌탈', '02-701-3285', '서울 금천구 가산동 한라시그마밸리 1101호', 'resource/img/camera2.jpg', '프로젝터, 스크린, TV, DID(LFD), 전광판, 음향장비, 전시용품', 5);
INSERT INTO company(com_name, com_tel, com_addr, com_img, com_desc, comCategory_code)
VALUES('이땅', '1544-7437', '대전광역시 유성구 테크노2로 125-5', 'resource/img/brand3.png', '대학 패션쇼와 예술고교 협찬 대폭 확대', 10);

INSERT INTO company(com_name, com_tel, com_addr, com_img, com_desc, comCategory_code)
VALUES('우리미디어', '1588-6992', '경기도 파주시 탄현면 한산로 70-12', 'resource/img/sound4.jpg', '유무선마이크대여, 앰프대여, 렌탈', 5);
INSERT INTO company(com_name, com_tel, com_addr, com_img, com_desc, comCategory_code)
